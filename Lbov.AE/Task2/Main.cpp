...
int main() {
	...
	int k,x,l,x1;
  cout << v;
	cout <<"1.—ложение векторов" <<endl<<"2.»ндексаци€"<<endl<<"3.—кал€рное умножение векторов"<<endl<<"4.”множение вектора на скал€р"<<endl<<"5.Ќахождение длины вектора"<<endl<<"6.ѕрисваивание вектора числу"<<endl;
	cin >> k;
	switch (k){
	case 1:
	...
	case 2:
		...
		cin >> x;
		cout << "введите новое значение переменной" << endl;
		cin >> l;
		v[k*4+x-2]=l;
		break;
	case 3:
